...
const FlyoutList: React.FC<FlyoutListProps> = ({ items, onNavigate, level = 0 }) => {
...
export const QuickMenuPopup: React.FC<Props> = ({ isOpen, onClose, anchorRef }) => {
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="relative overflow-visible rounded-[15px] border border-white/50 bg-white/85 shadow-[0_30px_90px_rgba(15,23,42,0.28)] ring-1 ring-slate-200/60 backdrop-blur-2xl">
              ...
              <div className="relative max-h-[92vh] overflow-visible p-5 sm:p-6">
